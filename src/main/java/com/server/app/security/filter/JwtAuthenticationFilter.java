package com.server.app.security.filter;
...
import com.server.app.domain.dto.response.ExceptionResponse;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            // findById lanza NotFoundException (capturada mas abajo) si el usuario
            // fue eliminado o soft-deleted, por lo que aqui nunca sera null.
